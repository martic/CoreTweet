...
namespace CoreTweet
{
    public static partial class Rest
    {
        public static class Statuses
        {
            ...
            {
                return CoreBase.ConvertArray<Status>(DynamicJson.Parse(Request.Send(Tokens, MethodType.GET, Rest.Url("statuses/mentions_timeline"), Parameters)));
            }
            ...
            {
                return CoreBase.ConvertArray<Status>(DynamicJson.Parse(Request.Send(Tokens, MethodType.GET, Rest.Url("statuses/user_timeline"), Parameters)));
            }
            ...
            {
                return CoreBase.ConvertArray<Status>(DynamicJson.Parse(Request.Send(Tokens, MethodType.GET, Rest.Url("statuses/home_timeline"), Parameters)));
            }
            ...
            {
                return CoreBase.ConvertArray<Status>(DynamicJson.Parse(Request.Send(Tokens, MethodType.GET, Rest.Url("statuses/retweets_of_me"), Parameters)));
            }
            ...
            {
                return CoreBase.Convert<Embed>(DynamicJson.Parse(Request.Send(Tokens, MethodType.GET, Rest.Url("statuses/oembed"), Parameters)));
            }
