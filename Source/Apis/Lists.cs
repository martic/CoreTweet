...
namespace CoreTweet
{
    public static partial class Rest
    {
        ...
        public static class Lists
        {
            ...
            /// Parameters.
            /// </param>
            public static CoreTweet.List Update(Tokens tokens, Expression<Func<string,object>> parameters)
            {
                return CoreBase.Convert<CoreTweet.List>(DynamicJson.Parse(
                    Request.Send(tokens, MethodType.POST, Rest.Url("lists/update"), parameters)));
            }
