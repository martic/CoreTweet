...
namespace CoreTweet
{
    public static partial class Rest
    {
        public static class Geo
        {
            ...
            //UNDONE: The POST Method. (POST geo/place)
            //GET Methods
            ...
            public static GeoResult SimilarPlaces(Tokens Tokens, params Expression<Func<string,object>>[] Parameters)
            {
                return CoreBase.Convert<GeoResult>(DynamicJson.Parse(
                    Request.Send(Tokens, MethodType.GET, TwiTool.GetAPIURL("geo/similar_places"), Parameters)).result);
            }
            ...
            {
                return CoreBase.Convert<GeoResult>(DynamicJson.Parse(
                    Request.Send(Tokens, MethodType.GET, TwiTool.GetAPIURL("geo/search"), Parameters)).result);
            }
            ...
            {
                return CoreBase.Convert<GeoResult>(DynamicJson.Parse(
                    Request.Send(Tokens, MethodType.GET, TwiTool.GetAPIURL("geo/reverse_geocode"), Parameters)).result);
            }
            ...
            {
                return CoreBase.Convert<Place>(DynamicJson.Parse(
                    Request.Send(Tokens, MethodType.GET, TwiTool.GetAPIURL("geo/reverse_geocode"), Parameters)));
            }
